...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $image_path = $post['image']; // Default to existing image
...
<head>
    ...
    <title>Edit Post - Vananta Admin</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto px-6 py-8">
        <div class="bg-white p-8 rounded-lg shadow-md max-w-3xl mx-auto">
            <h2 class="text-2xl font-bold mb-6 text-gray-800">Edit Postingan</h2>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="bg-teal-500 text-white px-4 py-2 rounded hover:bg-teal-600 transition">Update
                        Postingan</button>
                </div>
            </form>
        </div>
